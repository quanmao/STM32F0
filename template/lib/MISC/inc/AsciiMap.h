...
//const char loadingMap[8] = {0x40, 0x02, 0x01, 0x20, 0x40, 0x04, 0x08, 0x10}; 
//const char loadingMap[8] = {0x3F, 0x7D, 0x7E, 0x5F, 0x3F, 0x7B, 0x77, 0x6F}; 
const char loadingMap[6] = {0x01, 0x02, 0x04, 0x08, 0x10, 0x20};
